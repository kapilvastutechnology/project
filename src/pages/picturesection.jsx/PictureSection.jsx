...
//   return (
//     <div className="grid grid-cols-[minmax(860px,1fr)_minmax(100px,1fr)] gap-3 bg-gray-200 ">
//       <div>
...
//                 magna enim, ac accumsan tortor cursus at. Phasellus sed ultricies mi non congue ullam corper. Praesent tincidunt sed tellus ut rutrum. Sed vitae justo condimentum, porta lectus vitae, ultricies congue gravida diam non fringilla."</p>
...
//       <div>
//         <div className="w-full  flex items-center p-4  max-sm:flex-row">
//             <img
